...
const PropertyDetails = ({propertyDetails: {price, rentFrequency, rooms, title, baths, area, isVerified, description, type, agency, photos, purpose, furnishingStatus, amenities}}) => (
